...
================================================================================
 ...
 Description:
   This script is a clean version of the Bronze layer. The data types have been 
   adjusted to match the context of the data. There are minimal transformations, 
   with only a few simple derived columns added. The number of tables remains 
   the same as in the Bronze layer.
